 ...
 */
export const ProgressIndicator = ({ progress = 0, stage = '' }: ProgressIndicatorProps) => (
 ...
 */
export const ConversionLoader = ({ message = 'Converting...', progress, stage }: ConversionLoaderProps) => (
...
interface LargeFileIndicatorProps {
  sizeMB: number
}
 ...
 */
export const LargeFileIndicator = ({ sizeMB }: LargeFileIndicatorProps) => (
